	...
	// Crea tabla con listado de elementos capturados 
		...
		if($total_rows){
			foreach ($list_content as $value){
				...
				$eliminar = '<span style="color:red;" id="ico-eliminar_1" class="ico_eliminar fa fa-times" onclick="confirm_delete('.$value['id_administracion_puestos'].')" title="'.$this->lang_item("lbl_eliminar").'"></span>';
				$btn_acciones['eliminar'] = (!$puesto[0]['id_puesto'])?$eliminar:'<span style="color:gray;" id="ico-eliminar_1" class="ico_eliminar fa fa-times" title="'.$this->lang_item("lbl_eliminar").'"></span>';
