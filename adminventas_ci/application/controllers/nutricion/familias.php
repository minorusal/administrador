...
class familias extends Base_Controller{
	...
	public function listado($offset=0){
		...
		if($total_rows){
			foreach ($list_content as $value){
				...
				$ciclo = $this->db_model->db_get_familia_ciclo($accion_id);
				//print_debug($ciclo);
				...
				$btn_acciones['eliminar']       = (!$ciclo[0]['id_nutricion_ciclo_receta'])?$eliminar:'<span style="color:gray;" id="ico-eliminar_'.$accion_id.'" class="ico_eliminar fa fa-times" title="'.$this->lang_item("eliminar").'"></span>';
	...
	public function eliminar_registro(){
		...
		$ciclo = $this->db_model->db_get_familia_ciclo($id_familia);
		if(!$ciclo[0]['id_nutricion_ciclo_receta']){
			$sqlData = array(
