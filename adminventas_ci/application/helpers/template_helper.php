<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    if(!function_exists('plantilla_table_tpl')){
        function set_table_tpl(){
            return  array (
                            'table_open'          => '<table class="table table-striped responsive-utilities jambo_table bulk_action " >',

                            'heading_row_start'   => '<tr class="headings">',
                            'heading_row_end'     => '</tr>',
                            'heading_cell_start'  => '<th class="column-title">',
                            'heading_cell_end'    => '</th>',

                            'row_start'           => '<tr class="odd pointer">',
                            'row_end'             => '</tr>',
                            'cell_start'          => '<td style="max-width:80px;text-align:left;word-wrap:break-word;">',
                            'cell_end'            => '</td>',

                            'row_alt_start'       => '<tr class="even pointer">',
                            'row_alt_end'         => '</tr>',
                            'cell_alt_start'      => '<td style="max-width:80px;text-align:left;word-wrap:break-word;">',
                            'cell_alt_end'        => '</td>',
