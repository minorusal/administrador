...
class puestos extends Base_Controller
{
	...
	public function actualizar()
	{
		...
		{
			$sqlData = array(
				 'id_administracion_puestos' => $this->ajax_post('id_puesto')
	...
	public function agregar()
	{
		...
		$tab_1['nombre_puesto'] = $this->lang_item("nombre_puesto");
		$tab_1['puesto'] = $this->lang_item('puesto');
	...
	public function export_xlsx($offset=0){
		...
		$params = array(	'title'   => $this->lang_item("Catálogos Puestos"),
							'items'   => $set_data,
							'headers' => $set_heading
						);
