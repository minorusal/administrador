		...
		if((is_array($query_result))&&(!empty($query_result))){
			foreach ($query_result as $key => $value) {
				...
				$data[] = array(
								...
								'id_menu_n1'      => trim(trim($value['id_menu_n1'],',').','.trim($value['user_id_menu_n1'],','),','),
								'id_menu_n2'      => trim(trim($value['id_menu_n2'],',').','.trim($value['user_id_menu_n2'],','),','),
								'id_menu_n3'      => trim(trim($value['id_menu_n3'],',').','.trim($value['user_id_menu_n3'],','),','),
