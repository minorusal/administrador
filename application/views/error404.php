    ...
    <body class="errorpage">
        <div class="mainwrapper">
            <div class="errortitle">
                <h4 class="animate0 fadeInUp">La página que esta buscando no se ha encontrado.</h4>
                ...
                <div class="errorbtns animate4 fadeInUp">
                    <a onclick="history.back()" class="btn btn-primary btn-large">Ir a la Pagina Anterior</a>
                    <a href="inicio" class="btn btn-primary btn-large">Ir al Incio</a>
                </div>
            </div>
        </div>
    </body>
