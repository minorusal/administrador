...
function agregar_linea(){
	...
	jQuery.ajax({
		type:"POST",
		url: path()+"compras/catalogos/agregar_linea",
		dataType: "json",
...
function editar_linea(){
	...
	jQuery.ajax({
		type:"POST",
		url: path()+"compras/catalogos/actualizar_linea",
		dataType: "json",
...
function buscar_linea(){
	...
	if(filtro !== ''){
		jQuery.ajax({
	        type: "POST",
	        url: path()+"compras/catalogos/lineas",
	        dataType: 'json',
	        data: {filtro: filtro},
	        beforeSend : function(){
...
function detalle_linea(id_linea){
	...
	jQuery.ajax({
        type: "POST",
        url: path()+"compras/catalogos/detalle_linea",
        dataType: 'json',
