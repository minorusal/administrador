...
function buscar(){
  ...
  jQuery.ajax({
    type:"POST",
    url: path()+"sucursales/horarios_atencion/listado",
    dataType: "json",
    data: {filtro : filtro},
    beforeSend : function(){
...
function detalle(id_horario){
  jQuery('#ui-id-2').click();
  jQuery.ajax({
        type: "POST",
        url: path()+"sucursales/horarios_atencion/detalle",
        dataType: 'json',
...
function actualizar(){
   ...
   jQuery.ajax({
      type:"POST",
      url: path()+"sucursales/horarios_atencion/actualizar",
      dataType: "json",
...
function agregar(){
  ...
  jQuery.ajax({
    type:"POST",
    url: path()+"sucursales/horarios_atencion/insert_area",
    dataType: "json",
    data: {objData:objData},
    beforeSend : function(){
      btn.attr('disabled',true);
